...
console.log(
  chalk.hex('#d7a1ff').italic('     TERIMAKASIH TELAH MENGUNAKAN BAILEYS DARI KAMI\n') +
  chalk.hex('#a78bfa').italic('     TELEGRAM: @ApongSakata\n\n') +
  chalk.hex('#a78bfa').italic('     CHANNEL: @SakataCrasher\n\n') +
  chalk.hex('#d7a1ff').italic('     BILA ADA EROR SEGERA LAPOR\n')
);
